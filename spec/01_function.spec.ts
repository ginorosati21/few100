...
import { isEven, doubleIt } from './utils'; // autoimported with intellisense
...
describe('array methods', () => {
    ...
    describe('methods that return a single (scalar) value', () => {
        ...
        it('has some that allow you to test the membership', () => {
            ...
            const someEven = numbers.some(isEven) // c #All
...
describe('some examples', () => {
    ...
    it('a shopping cart', () => {
        // I have a cart, I want to know the totl bill
        interface CartItem {
            name: string;
            qty: number;
            price: number;
    ...
    it('combining a few things', () => {
        ...
        // write code to give me the make an model of the high milage vehicles (high mileage >= 200_000)
        const highMileageVehicles = vehicles // all the vehicles
